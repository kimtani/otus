...
сети 192.168.1.0/24?
 ...
 - В данной топологии маршрут по умолчанию имеет административное расстояние 110 (OSPF) и число переходов 1, а сеть 192.168.1.0/24 - это напрямую подключенная сеть. У нее AD 0, поэтому и стоимость больше.
